...
export class FormularioProductoComponent implements OnInit {
    ...
    listaTiposHabitacion: ParametricaSfe[] = [];
    ...
    ngOnInit(): void {
        ...
        this.parametricasSfeService.getTipoHabitacion().subscribe((data) => {
            this.listaTiposHabitacion = data as unknown as ParametricaSfe[];
        });
    ...
    public onSubmit(): void {
        if (this.closeClicked) {
            ...
            if (this.itemForm.controls['idTipoProducto'].value===spv.TIPO_PRODUCTO_CON_INVENTARIO && this.itemForm.controls['precio'].value>0) {
            ...
            const producto: Producto = {
                ...
                precioIce: this.itemForm.controls['precioIce'].value,
