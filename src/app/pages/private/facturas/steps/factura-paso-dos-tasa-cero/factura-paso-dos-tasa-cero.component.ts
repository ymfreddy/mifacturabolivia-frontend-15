...
@Component({
  selector: 'app-factura-paso-dos-tasa-cero',
  templateUrl: './factura-paso-dos-tasa-cero.component.html',
  styleUrls: ['./factura-paso-dos-tasa-cero.component.scss']
})
export class FacturaPasoDosTasaCeroComponent implements OnInit {
