...
@Component({
  selector: 'app-factura-paso-dos-turismo',
  templateUrl: './factura-paso-dos-turismo.component.html',
  styleUrls: ['./factura-paso-dos-turismo.component.scss']
})
export class FacturaPasoDosTurismoComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.itemForm = this.fb.group({
            ...
            razonSocialOperadorTurismo :[this.item?.factura?.cabecera?.razonSocialOperadorTurismo, Validators.required]
        });
    }
